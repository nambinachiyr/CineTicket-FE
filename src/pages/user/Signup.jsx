...
const Signup = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen rounded-2xl bg-linear-to-b from-yellow-50 via-yellow-200 to-yellow-50'>
      <form onSubmit={handleSignup} className='border hover:border-amber-500 hover:border-2 hover:rounded-t-4xl flex flex-col gap-8 md:gap-15 mx-auto font-semibold w-full max-w-md rounded-xl p-6 md:p-9 bg-gray-100 shadow-yellow-100 shadow-2xl'>
        ...
        <div className='flex flex-col md:text-xl space-y-10  justify-center items-center'>
          <input type='name' value={userName} onChange={(e) => setUserName(e.target.value)} placeholder='Enter Your Name' className='w-full text-center focus:text-left hover:cursor-pointer hover:placeholder-transparent max-w-md px-9  h-11 border border-transparent hover:border-amber-500  hover:rounded-t-4xl focus:outline-none rounded-md focus:border-amber-500 p-4' />
          <input type='email' value={email} onChange={(e) => setEmail(e.target.value)} placeholder='Enter Your Email' className='w-full text-center focus:text-left hover:cursor-pointer hover:placeholder-transparent max-w-md px-9  h-11 border border-transparent hover:border-amber-500  hover:rounded-t-4xl focus:outline-none rounded-md focus:border-amber-500 p-4' />
        ...
        <div className='flex gap-2 items-center justify-center flex-col '>
          <button className='border-transparent w-full py-3 text-md md:text-xl hover:text-white hover:shadow-md shadow-yellow-300 focus:outline-none hover:rounded-4xl rounded-lg hover:bg-amber-300 hover:cursor-pointer'>{loading ? <LoadSpin /> : "Signup"}</button>
